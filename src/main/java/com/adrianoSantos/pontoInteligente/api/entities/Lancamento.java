...
public class Lancamento implements Serializable {
	...
	@Column(name="data_atualizacap", nullable=true)
	...
	public String toString() {
		return "Lancamentos [id=" + id +" , data =" + data +", descricao = " + descricao + ", localizacao= " + localizacao + ", tipo=" + tipo + ", funcionario=" + funcionario + ""
